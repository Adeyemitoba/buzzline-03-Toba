"""
csv_producer_Adeyemi.py

Stream weather data to a Kafka topic.
...
DATA_FOLDER = pathlib.Path("C:/Users/snarc/Documents/buzzline-03-Toba/data")
logger.info(f"Data folder: {DATA_FOLDER}")

# Set the name of the data file
DATA_FILE = DATA_FOLDER.joinpath("weather_data.csv")
        ...
        try:
            ...
            with open(DATA_FILE, "r") as csv_file:
                ...
                for row in csv_reader:
                    ...
                    if "temperature" not in row or "humidity" not in row or "pressure" not in row:
